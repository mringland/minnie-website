...
Check out our project website [here](https://carboncounters.weebly.com/)
...
knitr::include_graphics("ESM_271_Report.pdf")
```
...
```{r out.width="100%", out.height="500"}
knitr::include_graphics('Dole_SustainabilityPlan_ESM281_March2021.pdf')
```
