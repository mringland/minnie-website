...
```{r fig.cap="**Figure 1.** 2008 Oil Spills in California"}
#ggplot() +
...
untib_subset <- untibble(ca_subset)
untib_new <- untibble(new_spill_data)

# Set viewing mode to "interactive":
tmap_mode(mode = "view")

tm_shape(untib_subset) +
...
```{r fig.cap="**Figure 2.** Chloropleth showing counties color-coded by spill frequency"}
